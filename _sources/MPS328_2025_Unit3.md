...
Bosons have integer spin, i.e. $0, \hbar, 2 \hbar, \ldots$ And include particles such as the photon $(\gamma)$, pions $(\pi)$ and other mesons. They include the quanta of fields, i.e. the carriers of forces $W^{ \pm}, Z$, gluon. Bosons can be created and destroyed in any number e.g.
...
$$
\begin{equation*}
E \rightarrow i \hbar \frac{\partial}{\partial t} ; \quad p_{x} \rightarrow -i\hbar \frac{\partial}{\partial x} ; \quad p_{y}  \rightarrow -i \hbar\frac{\partial}{\partial y} ; \quad p_{z}  \rightarrow -i \hbar \frac{\partial}{\partial z} 
\end{equation*}
$$
